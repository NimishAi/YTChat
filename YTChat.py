...
OPENAI_API_KEY = "--Inser YOUR OPENAI API KEY HERE--"
...
config = {
    # This is a sample configuration for the Memory client
    "version": "v1.1",
    "embedder": { # Embedding model for vector database
        "provider": "openai",
    ...
    "graph_store": { # Graph database for storing relationships
        "provider": "neo4j",
